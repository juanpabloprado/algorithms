...
def merge_sort(values):
    ...
    # divides and rounds the result down: the floor division operator.
    ...
    # right index variable to track that position as well.
    right_index = 0
    ...
    while left_index < len(left_values) and right_index < len(right_values):
        ...
        # wether the current value on the left side is less than the value on the
        # right side.
